        ...
        <div
            ...
            <div class="border-b-solid mb-2 rounded-t-2xl border-b-0 border-b-transparent p-6 pb-0">
                <div class="flex items-center justify-between">
                    <h6 class="m-0 font-bold text-gray-700 dark:text-white">Edit Book</h6>
            ...
            <form action="{{ route('admin.books.update', $book->slug) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-4 px-4 pb-2 pt-0">
                    ...
                    <textarea
                        ...
                        name="description" rows="5" placeholder="Description">{{ $book->description }}</textarea>
                    <div class="flex flex-col gap-4 lg:flex-row">
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row">
                        ...
                        <select id="publisher" name="publisher_id" style="width: 100%">
                            <option value="{{ $book->publisher->id }}" selected="selected">{{ $book->publisher->name }}
                            </option>
                        </select>
                    </div>
                    <label class="w-full">
...
@section('tail')
    ...
    <script>
        $(document).ready(function() {
            ...
            var authors = {!! json_encode($book->authors->toArray()) !!}
            ...
            var categories = {!! json_encode($book->categories->toArray()) !!}
